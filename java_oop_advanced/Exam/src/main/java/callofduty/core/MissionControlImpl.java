...
public class MissionControlImpl implements MissionControl {
    ...
    private void initMissionClasses() {
        try {
            this.missionClasses = new LinkedHashMap<String, Class>() {{
                put("EscortMission", Class.forName("main.java.callofduty.domain.missions.EscortMission"));
                put("HuntMission", Class.forName("main.java.callofduty.domain.missions.HuntMission"));
                put("SurveillanceMission", Class.forName("main.java.callofduty.domain.missions.SurveillanceMission"));
            }};
    ...
    public Mission generateMission(String missionId, Double missionRating, Double missionBounty) {
        ...
        return this.instantiateMissionObject(missionId, missionBounty, missionRating);
    }
}